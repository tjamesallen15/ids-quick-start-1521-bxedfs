...
export class AppComponent implements AfterViewInit {
  ...
  constructor(
    ...
    private _modalService: SohoModalDialogService
  ) {
  ...
  openDialog() {
    const dialogRef = this._modalService
      .modal<DialogComponent>(DialogComponent, this.placeholder, {
        fullsize: 'responsive',
      })
      .buttons([
        {
        ...
        },
        {
          ...
          click: () => {
            dialogRef.close();
            //quickAddValues = dialogRef.componentDialog.filterValue;
            //console.log(quickAddValues);
          },
          isDefault: true,
        },
      ])
